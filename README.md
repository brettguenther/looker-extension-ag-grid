# Looker Extension looker-ag-grid-extension

looker-ag-grid-extension is a Looker extension using React and JavaScript.
...
5. Create a `manifest` file
   ...
   ```
    ...
    application: looker-ag-grid-extension {
        label: "looker-ag-grid-extension React/JavaScript extension"
